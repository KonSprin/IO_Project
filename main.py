...
class MainWindow(QMainWindow):
    ...
    def chooseVideo(self):
        ...
        fname = QFileDialog.getOpenFileName(self, 'Choose Video', str(os.path.dirname(os.path.abspath(__file__))), "Video Files (*.mp4 *.mkv *.avi)")
    ...
    def chooseSaveFile(self):
        ...
        fname = QFileDialog.getExistingDirectory(self, 'Choose Log File', str(os.path.dirname(os.path.abspath(__file__))))
        # SET lineEdit TO CHOSEN PATH
